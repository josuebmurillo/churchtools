...
export type AttendanceSnapshot = { fecha: string; event_id?: number | null; total_asistencia: number; total_visitantes: number; event_name?: string }
export type ParticipationReport = { total_activos: number; total_voluntarios: number; event_id?: number | null }
export type ParticipationSnapshot = { fecha: string; event_id?: number | null; total_activos: number; total_voluntarios: number; event_name?: string }
